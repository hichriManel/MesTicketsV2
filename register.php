                ...
                <div class="container-xxl">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                            <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;max-height:98vh;overflow:scroll;overflow-x:hidden;">
                                <!-- Form -->
                                <form class="row g-1 p-3 p-md-4" method="post" action="controller/compte/register.php">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control form-control-lg" placeholder="ben foulen" name="prenom">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Nom</label>
                                            <input type="text" class="form-control form-control-lg" placeholder="foulen" name="nom">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="email" class="form-control form-control-lg" placeholder="nom@example.com" name="email">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label class="form-label">Numéro de Téléphone </label>
                                            <input type="tel" class="form-control form-control-lg" placeholder="33003300" name="tel">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Password</label>
                                            <input type="password" class="form-control form-control-lg" placeholder="8+ caractères requis" name="mdp">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Confirm password</label>
                                            <input type="password" class="form-control form-control-lg" placeholder="réécrire le mot de passe" name="cmdp">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Nom de l'entreprise </label>
                                            <input type="tel" class="form-control form-control-lg" placeholder="EntrepriseX" name="noms">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-2">
                                            <label class="form-label">Adresse de l'entreprise </label>
                                            <input type="text" name="adresse" class="form-control form-control-lg" placeholder="Avunue Bourgiba Centre nourhene ">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="mb-2">
                                            <label class="form-label">Numéro de Téléphone de l'entreprise </label>
                                            <input type="tel" class="form-control form-control-lg" placeholder="33003300" name="nums">
                                        </div>
                                    </div>
